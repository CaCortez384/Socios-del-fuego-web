      ...
      <nav className="sticky top-0 z-50 w-full border-b border-stone-800 bg-stone-950/90 backdrop-blur-md">
        <div className="container mx-auto flex h-20 items-center justify-between px-4">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-stone-400">
            ...
            <Link
              href="#cordero"
              className="hover:text-orange-500 transition-colors text-orange-400"
            >
              Cordero al Palo
            </Link>
            <Link
            ...
            <Link
              href="/blog"
              className="hover:text-orange-500 transition-colors font-bold text-stone-200"
            >
              Blog Parrillero
            </Link>
          </div>
      ...
      <main>
        ...
        <section className="relative min-h-[85vh] w-full flex items-center justify-center overflow-hidden border-b border-stone-800">
          ...
          <div className="relative z-10 container px-4 text-center">
            ...
            >
              <Badge
                variant="outline"
                className="mb-6 border-orange-600/50 text-orange-500 px-4 py-1 tracking-widest uppercase bg-stone-950/50 backdrop-blur-sm"
              >
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-stone-400">
              Todo incluido: Parrilleros, insumos y equipamiento.
            </p>
          </div>
              ...
              <CardContent className="flex-1">
                <ul className="space-y-3 text-sm text-stone-300">
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-orange-700 shrink-0 mt-0.5" />{" "}
                    Lomo Liso o Vetado
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-orange-700 shrink-0 mt-0.5" />{" "}
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-stone-600 shrink-0 mt-0.5" />{" "}
                    Pimientos y Zapallitos
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent className="flex-1">
                <ul className="space-y-3 text-sm text-stone-300">
                  <li className="flex items-start gap-2">
                    ...
                    Cortes Premium + Malaya
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-sky-500 shrink-0 mt-0.5" />{" "}
                    <strong>Buffet Americano (Ensaladas)</strong>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-sky-500 shrink-0 mt-0.5" />{" "}
              ...
              <CardContent className="flex-1">
                <ul className="space-y-3 text-sm text-stone-200 font-medium">
                  <li className="flex items-start gap-2">
                    ...
                    <strong>Filete Premium</strong> a la parrilla
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-yellow-500 shrink-0 mt-0.5" />{" "}
                    Selección de Lomo y Puntas
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-yellow-500 shrink-0 mt-0.5" />{" "}
                    Buffet Americano Completo
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-yellow-500 shrink-0 mt-0.5" />{" "}
                    Servicio de Lujo
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 bg-stone-950 p-8 rounded-2xl border border-stone-800">
              <div className="md:w-1/2">
                ...
                <p className="text-stone-300 text-lg mb-8">
                  La preparación tradicional magallánica al asador vertical. Un
                  espectáculo visual y gastronómico para tu evento. Cocción
                  lenta de 4 a 6 horas para lograr una carne que se deshace.
                </p>
                <Button
                  asChild
                  size="lg"
              ...
              <div className="md:w-1/2 h-64 md:h-80 w-full bg-stone-800 rounded-xl flex items-center justify-center border border-stone-700 relative overflow-hidden group">
                <Image
                  src="/cordero.webp"
                  alt="Cordero al Palo al estilo magallánico cocinándose a fuego lento"
                  fill
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-stone-400">
              Llegamos donde tú estés. Costo de transporte según zona.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
            <Card className="bg-stone-900 border-stone-800">
              <CardHeader className="pb-2">
                <CardTitle className="font-oswald text-white flex items-center gap-2">
                  <MapPin className="text-orange-600 h-5 w-5" /> Melipilla
                  (Provincia)
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-stone-900 border-stone-800">
              <CardHeader className="pb-2">
                <CardTitle className="font-oswald text-white flex items-center gap-2">
                  <MapPin className="text-orange-600 h-5 w-5" /> V Región /
                  Litoral
                </CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <section className="container mx-auto px-4 mb-24">
          <Alert className="bg-stone-900 border-orange-900/50 text-stone-300">
            ...
            <AlertTitle className="text-orange-500 font-oswald uppercase tracking-wide ml-2">
              Servicio 100% Gastronómico
            </AlertTitle>
            <AlertDescription className="ml-2 text-stone-400">
              Nos enfocamos exclusivamente en la calidad de la carne y el fuego.
              <span className="text-stone-200 font-medium">
                {" "}
                (El servicio no incluye vajilla ni mobiliario).
              </span>
            </AlertDescription>
          </Alert>
        </section>
        ...
        >
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem
              value="item-1"
              className="border-stone-800 bg-stone-900/50 px-4 rounded-lg"
            >
              <AccordionTrigger className="text-stone-200 hover:text-orange-500 hover:no-underline">
                ¿Qué incluye el servicio?
              </AccordionTrigger>
              <AccordionContent className="text-stone-400">
                Maestros parrilleros, carbón, parrillas (si es necesario) y
                todos los insumos de comida detallados en tu plan.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
              value="item-2"
            ...
            >
              ...
              <AccordionContent className="text-stone-400">
                Transferencia del 50% para bloquear la fecha. El saldo restante
                se paga el día del evento al llegar el equipo.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </section>
      ...
      <section className="py-16 bg-stone-900 border-t border-stone-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-stone-400 max-w-2xl mx-auto mb-8">
            ¿No sabes calcular la carne? ¿Dudas entre Lomo y Punta de Ganso?
            Visita nuestro blog y aprende los secretos de nuestros maestros
            parrilleros.
          </p>
          <div className="flex justify-center gap-4">
            ...
            >
              <Link href="/blog/como-calcular-carne-asado">
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-stone-500 text-sm mt-1">
              El mejor aliado para tu parrilla.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 text-sm text-stone-400">
            ...
            <a
              href="https://instagram.com/sociosdelfuego"
              target="_blank"
              className="hover:text-orange-500 flex items-center gap-2 justify-center md:justify-start"
            >
