...
export const PLANS = [
  // --- AL PLATO (FULL) ---
  {
    ...
    priceLevel: 3,
    priceLabel: "$$$",
    totalWeight: "1 Corte + 2 Guarniciones",
    colorTheme: {
    ...
    features: [
      "Menú plato a la mesa por garzones",
      "Lomo Vetado a la parrilla",
      "2 Guarniciones a elección",
      "Ensaladas incluidas",
    ],
    fullMenu: {
      carnes: [
      ...
      ensaladas: [
        "Choclo con mayonesa",
        "Ensalada mixta",
        "Palmitos palta-cebollin",
        "--- GUARNICIONES (Elegir 2) ---",
        "Champiñones al pil pil",
        "Zapallo italiano asado con queso gratinado",
        "Espárragos asados envueltos en tocino",
        "Papas rústicas"
      ],
      servicio: "Servicio completo de parrillada con 2 Maestros Parrilleros y 2 Garzones, insumos, parrillas y vajilla.",
    },
  },
  {
    id: "total",
...
export const ADDONS_DATA = {
  coffeeBreak: {
    id: "coffeeBreak",
    pricePerPerson: 7500,
    label: "Coffee Break / Desayuno",
    description: "Bebidas calientes, jugos, tapadito de pollo + sándwich jamón queso, porción dulce a elección y acompañamientos caseros.",
  },
  mobiliario: {
    id: "mobiliario",
    pricePerPerson: 10000,
    label: "Mobiliario Completo",
    description: "Mesa, silla, mantelería, vajilla, cristalería y montaje.",
  },
  postres: {
    id: "postres",
    pricePerPerson: 3500,
    label: "Postres a la Parrilla",
    description: "Piña caramelizada a la parrilla c/ helado y galletas o Frutilla caramelizada al vino tinto c/ helado.",
  },
  cordero: {
    id: "cordero",
    price: 200000,
